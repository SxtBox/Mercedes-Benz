...
Kur del mesazhi ✅ → luan “success.mp3”

Kur del ⚠️ → luan “warn.mp3”

Kur del ❌ → luan “error.mp3”

Efektet luajnë me një vonesë të vogël që krijon ndjesinë e “progress check”.
<!---->
<!DOCTYPE html>
<html lang="sq">
<head>
...
<!-- Efekte zanore -->
<audio id="sound-ok" src="https://cdn.jsdelivr.net/gh/olci-sounds/success.mp3"></audio>
<audio id="sound-warn" src="https://cdn.jsdelivr.net/gh/olci-sounds/warn.mp3"></audio>
<audio id="sound-err" src="https://cdn.jsdelivr.net/gh/olci-sounds/error.mp3"></audio>
...
document.getElementById("turboForm").addEventListener("submit", async (e) => {
    ...
    data.mesazhe.forEach((msg, i) => {
        ...
        // vonesë e vogël për efekt "sequential fade"
        setTimeout(() => {
