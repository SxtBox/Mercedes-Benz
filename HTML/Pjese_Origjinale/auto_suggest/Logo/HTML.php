...
<title>Kontrollo Pjesën me Logo dhe Efekt</title>
<style>
:root {
    --lime: #33ff66;
    --bg: #0c0c0c;
...
.flash {
    animation: flash 0.3s ease 0s 2;
}
@keyframes flash {
...
input.addEventListener('input',()=>{
    ...
    if(det.logo){ logo.src=det.logo; logo.style.display='block'; logo.classList.remove('shake','flash'); } 
    else { logo.style.display='block'; logo.src='logos/error.png'; logo.classList.add('shake','flash'); } // logo gabimi
});
